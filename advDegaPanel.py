...
class advDegaPanel(wx.Panel):
    def __init__(self, parent, coils):
        ...
        self.coilselector = wx.ComboBox(self.panel, -1, str(coils.keys()[0]), wx.DefaultPosition, (200,-1), coils.keys()[:-2], wx.CB_READONLY)
        ...
        self.textAmp.SetValue(str(self.coils[str(coils.keys()[0])]['Amp']))
        ...
        self.textFreq.SetValue(str(self.coils[str(coils.keys()[0])]['Freq']))
        ...
        self.textDur.SetValue(str(self.coils[str(coils.keys()[0])]['Dur']))
        ...
        self.textKeep.SetValue(str(self.coils[str(coils.keys()[0])]['Keep']))
